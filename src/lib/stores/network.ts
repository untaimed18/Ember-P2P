...
export function cleanupNetworkStore() {
  ...
  networkStats.set({
    ...
    epx_sources_received: 0, epx_events_received: 0,
    broker_punch_attempts: 0, broker_punch_successes: 0,
    broker_punch_failures: 0, broker_relay_attempts: 0,
    broker_relay_successes: 0, broker_relay_failures: 0,
